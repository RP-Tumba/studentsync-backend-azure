...
import { getAllStudents, deleteStudent, updatestudents, selectingSpecific, insertingstudent,selectingStudentByFirstName } from "../controllers/student.controller.js";
...
router.get('/name/:first_name', selectingStudentByFirstName);
